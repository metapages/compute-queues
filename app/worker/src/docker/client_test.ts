...
Deno.test("test docker building", async () => {
  ...
  try {
    ...
    const stream = await docker.buildImage("", {remote:"https://github.com/metapages/metapage-docker-job-test-run-from-repo.git#main", t:"metapages/metapage-docker-job-test-run-from-repo"});
